...
<div class="main-dash-container">
  ...
  <div class="dashboard-container">
    <h1 class="title text-black">Aged Data Recorded</h1>
    ...
    <div class="content-box-wrapper" style="display: block;">
      <div class="views-button-container">
        ...
        <button class="views-btn active" onclick="window.location.href='<?= ROOT_URL ?>view-aged.php';">Aged</button>
      </div>
    </div>
    ...
    <div style="margin-top: 2rem;" class="sub-container">
      ...
      <div class="wrapper">
        ...
        <div class="ellipse-dropdown el-first">
          <button class="top-btn">
            <h4 class="text-blue">Mmasiriwa - The Aged</h4>
          </button>
          <div class="action">
            ...
            <div class="action-box">
              ...
              <button class="action-btn" onclick="window.location.href='<?= ROOT_URL ?>reports/aged-report.php';">
        ...
        <?php
        $sno = 1;
        $fetch_members_query = " SELECT * FROM members WHERE member_type='Aged' ORDER BY id DESC";
      ...
      <div class="wrapper">
        ...
        <div class="ellipse-dropdown">
          ...
          <div class="action">
            ...
            <div class="action-box yth-bx">
              <button class="action-btn" onclick="window.location.href='<?= ROOT_URL ?>views.php;">View All</button>
              <button class="action-btn" onclick="window.location.href='<?= ROOT_URL ?>member.php';">Add a Member</button>
              <button class="action-btn border-top close-action-box" onclick="this.parentElement.remove()">close</button>
            </div>
          </div>
        </div>
        <!-- recent children box -->
        <?php
        $query = " SELECT * FROM members where member_type='Aged' ORDER BY id DESC LIMIT 5";
