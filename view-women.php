...
<div class="main-dash-container">
  ...
  <div class="dashboard-container">
    <h1 class="title text-black">Women's Data</h1>
    ...
    <div class="content-box-wrapper" style="display: block;">
      <div class="views-button-container">
        ...
        <button class="views-btn active" onclick="window.location.href='<?= ROOT_URL ?>view-women.php';">Women</button>
    ...
    <div style="margin-top: 2rem;" class="sub-container">
      ...
      <div class="wrapper">
        ...
        <div class="ellipse-dropdown el-first">
          <button class="top-btn">
            <h4 class="text-blue">All Women Recorded</h4>
          </button>
          <div class="action">
            ...
            <div class="action-box">
              ...
              <button class="action-btn" onclick="window.location.href='<?= ROOT_URL ?>reports/women-report.php';">
        ...
        <?php
        $sno = 1;
        $fetch_members_query = " SELECT * FROM members WHERE title='Dcns' OR title='Sis' ORDER BY id DESC";
      ...
      <div class="wrapper">
        ...
        <!-- recent women box -->
        <?php
        $query = " SELECT * FROM members where title='Dcns' || title='Sis' ORDER BY id DESC LIMIT 5";
