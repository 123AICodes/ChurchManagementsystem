    ...
    <div class="print-container">
      ...
      <div style="margin-top: 1rem;" class="flex none">
        ...
        <div class="container offerings">
          ...
          <div class="wrap">
            ...
            <a href="<?= ROOT_URL ?>reports/evangelism-offering-report.php" class="offering-btn active">Evangelism Finance</a>
            <a href="<?= ROOT_URL ?>reports/welfare-offering-report.php" class="offering-btn">Welfare Finance</a>
          </div>
        </div>
        <?php
        $sno = 1;
        $query = " SELECT * FROM finance WHERE ministry='Evangelism' ORDER BY id DESC";
      ...
      <?php if (mysqli_num_rows($results) > 0) : ?>
        <div class="content-wrapper offer">
          ...
          <h2 style="text-align:center; font-size:1.3rem">Evangelism Finance Data</h2>
          <table class="recent-table">
            ...
            <thead>
              <tr style="background: none;">
                ...
                <th style="padding: .5rem;border:1px solid var(--black)">Ministry</th>
