    ...
    <div class="print-container">
      ...
      <div style="margin-top: 1rem;" class="flex none">
        ...
        <div class="container offerings">
          ...
          <div class="wrap">
            ...
            <a href="<?= ROOT_URL ?>reports/children-offering-report.php" class="offering-btn active">Children Finance</a>
        ...
        <?php
        $sno = 1;
        $query = " SELECT * FROM finance WHERE ministry='Children' ORDER BY id DESC";
      ...
      <?php if (mysqli_num_rows($results) > 0) : ?>
        <div class="content-wrapper offer">
          ...
          <h2 style="text-align:center; font-size:1.3rem">Children's Finance Report</h2>
