    ...
    <div class="print-container">
      ...
      <div style="margin-top: 1rem;" class="flex none">
        ...
        <div class="container offerings">
          <div class="wrap">
            ...
            <a href="<?= ROOT_URL ?>reports/missions-offering-report.php" class="offering-btn active">Missions offering</a>
          </div>
          <div class="wrap">
        ...
        <?php
        $sno = 1;
        $query = " SELECT * FROM finance WHERE type='Missions' AND period='Monthly' ORDER BY id DESC";
      ...
      <?php if (mysqli_num_rows($results) > 0) : ?>
        <div class="content-wrapper offer">
          ...
          <h2 style="text-align:center; font-size:1.3rem">Missions Offering Data</h2>
