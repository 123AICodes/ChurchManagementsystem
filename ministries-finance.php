...
<div class="main-dash-container">
  ...
  <div class="dashboard-container">
    <h1 class="title text-black">Ministries Finances</h1>
    ...
    <div class="form-content-container content-box-wrapper" style="display: block;">
      <div class="views-button-container" style="margin-bottom: 1rem;">
        ...
        <button class="views-btn active" onclick="window.location.href='<?= ROOT_URL ?>ministries-finance.php';">Ministries</button>
      </div>
      <!-- error message -->
      <?php
      ...
      <div class="form-container">
        <form action="<?= ROOT_URL ?>logic/ministries-finance-logic.php" method="post" enctype="multipart/form-data" class="form" autocomplete="off">
          <div class="flex">
            <div class="input-box">
            ...
            <div class="input-box">
              <span>amount</span>
              <input type="number" min="1" value="<?= $amount ?>" name="amount" class="box">
            </div>
          </div>
          <div class="flex">
            <div class="input-box">
              <span>received from</span>
              <input type="text" name="received-from" value="<?= $received_from ?>" placeholder="name" class="box">
            </div>
            <div class="input-box">
              <span>received by</span>
              <input type="text" name="received-by" placeholder="name" value="<?= $user['firstname'] . ' ' . $user['lastname'] ?>" class="box">
            </div>
          </div>
          <div class="flex">
            <div class=" input-box">
              <span>expenses</span>
              <input type="number" name="expenses" value="<?= $amount ?>" class="box" min="1">
            </div>
          </div>
